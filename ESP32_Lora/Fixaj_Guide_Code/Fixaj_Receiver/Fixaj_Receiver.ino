...
//yeni ayarDeis fonksiyonu kullanıyor.
...
void ayarDegis() {
  if (Ayarmode) {
    ...
    delay(100);
    fixajSerial.println("AT+RSCFG=100");  //Node ağa bağlanmazsa yeniden başlat
    delay(100);
    ...
    Serial.println("Ayarlar degisti, Yeniden Başlatılıyor \nMevcut Ayarlar Getiriliyor..");
    delay(5000);
    mevcutAyarlar();
  }
}
